        ...
        <div>
            ...
            <nav className='hidden md:flex'>
                <ul className='flex items-center gap-12 text-[#6B72809] font-[400] text-[18px]'>
                    ...
                    <Exlink to='/signin'>
                    <Button
                        className="uppercase font-source-sans bg-[#8effe8] text-[#1F1F39] px-9 py-2 rounded-[7px] text-lg"
                        title="Login" 
                        link='/signin'/>
                    </Exlink>
                    <Exlink to='/signup'>
                    <Button
                        className="uppercase font-source-sans bg-[#1F1F39] text-white px-9 py-2 rounded-[7px] text-lg"
                        title="Sign up" 
                        link='/signup'/>
                    </Exlink>
                </ul>
